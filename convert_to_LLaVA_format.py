...
# Example usage
input_jsonl_path = './data/conversations_dataset.jsonl'  # Replace with your input JSONL file path
output_json_path = 'robot_hand_pose.json'  # Replace with your desired output JSON file path
